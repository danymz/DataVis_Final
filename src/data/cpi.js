...
export const CPI_DATA = {
  ...
  2010: 218.1, 2011: 224.9, 2012: 229.6, 2013: 232.9, 2014: 236.7, 2015: 237.0, 2016: 240.0, 2017: 245.1, 2018: 251.1, 2019: 255.7,
  2020: 258.8, 2021: 270.9, 2022: 292.7, 2023: 305.0
};

export function getCPI(year) {
  return CPI_DATA[year] || null;
}

export function getLatestCPI() {
  const years = Object.keys(CPI_DATA).map(Number);
  return CPI_DATA[Math.max(...years)];
} 